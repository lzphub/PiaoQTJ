...
public class MyIntentionProgressFragment extends BaseFragment implements MyIntentContact.fcView {
    ...
    protected void initComponents(View view) {
        ...
        myIntentPresenter.getData("3", pageIndex, 20);
        swipeToloadLayout.setOnLoadMoreListener(() -> {
            pageIndex++;
            myIntentPresenter.addData("3",pageIndex,20);
        });
