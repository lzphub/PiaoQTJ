...
public class MyIntentionSubmittedFragment extends BaseFragment implements MyIntentContact.fcView {
    ...
    protected void initComponents(View view) {
        ...
        myIntentPresenter.getData("1", pageIndex, 20);
        swipeToloadLayout.setOnLoadMoreListener(() -> {
            pageIndex++;
            myIntentPresenter.addData("1",pageIndex,20);
        });
