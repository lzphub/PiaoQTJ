...
public class CashInFragment extends BaseFragment implements CashInConract.mtView {
    ...
    protected void initComponents(View view) {
        ...
        cashInPresenter.getData(XZUserManager.getUserInfo().getId() + "", "0");

        swipeToloadLayout.setOnRefreshListener(() -> cashInPresenter.getData(XZUserManager.getUserInfo().getId() + "", "0"));
    }
