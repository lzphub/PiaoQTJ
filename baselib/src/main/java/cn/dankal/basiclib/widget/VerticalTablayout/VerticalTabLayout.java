package cn.dankal.basiclib.widget.VerticalTablayout;
...
public class VerticalTabLayout extends ScrollView implements View.OnClickListener {
    ...
    private static TabStrip mTabStrip;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        selectBgColor=typedArray.getColor(R.styleable.VerticalTablayout_selectBgColor,selectBgColor);
        unSelectBgColor=typedArray.getColor(R.styleable.VerticalTablayout_unSelectBgColor,unSelectBgColor);
    ...
    private class TabView extends FrameLayout {
        ...
        public TabView(Context context, Tab tab) {
            ...
            mTabItem.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        private LayoutParams createLayoutParams() {
            ...
            params.gravity = mTabGravity | Gravity.CENTER;
        ...
        public void setSelected(boolean selected) {
            ...
            if (mTabItem != null) {
                ...
                mTabItem.setBackgroundColor(selected? selectBgColor:unSelectBgColor);
            }
