package cn.dankal.basiclib.push;
        ...
        if (JPushInterface.ACTION_NOTIFICATION_OPENED.equals(intent.getAction())) {
            if (bundle != null) {
                ...
                try {
                    ...
                    /*if (DankalApplication.getAppComponent() != null &&
                            DankalApplication.getAppComponent().getTokenManager() != null) {
                        TokenManager userManager = DankalApplication.getAppComponent().getTokenManager();
