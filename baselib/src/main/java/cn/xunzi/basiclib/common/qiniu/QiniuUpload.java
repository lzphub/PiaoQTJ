    ...
    protected void beginQiniuImageUpload(String token, final String path, final UploadListener uploadListener) {
      /*  data = <File对象、或 文件路径、或 字节数组>
        ...
        String token = <从服务端SDK获取>;*/
         ...
         String user_id = String.valueOf(XZUserManager.getUserInfo().getId());
        String key = "pqtj_"+ String.valueOf(System.currentTimeMillis())+ user_id+".png";
...
//                    Logger.e(info.error);
    ...
    protected void beginQiniuVideoUpload(String token, final String localPath, final UploadListener uploadListener) {
      /*  data = <File对象、或 文件路径、或 字节数组>
        ...
        String user_id = String.valueOf(XZUserManager.getUserInfo().getId());
        String key = "pqtj_" + String.valueOf(System.currentTimeMillis())+ user_id+".mp4";
